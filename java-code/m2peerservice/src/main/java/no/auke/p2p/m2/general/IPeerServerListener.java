...
public abstract class IPeerServerListener extends IListener {
	public IPeerServerListener(int Loglevel) {
		super(Loglevel);
	}
	@Override
	...
	public void connectionRejected(NetAddress kaServerAddress, String msg) {
		debug("Connection rejected from KA " + kaServerAddress.getAddressPort() + " " + msg);
	}
	@Override
